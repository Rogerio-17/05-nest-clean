...
describe('Fetch answer comments (E2E)', () => {
    ...
    test('[GET] answers/answerId/comments', async () => {
        ...
        await Promise.all([
            answerCommentFactory.makePrismaAnswerComment({ authorId: user.id, answerId: answer.id, content: 'comment 1' }),
            answerCommentFactory.makePrismaAnswerComment({ authorId: user.id, answerId: answer.id, content: 'comment 2' }),
        ])
